...
theme.font          = "JetBrainsMono Nerd Font 7" 
...
theme.titlebar_minimize_button_normal = "~/.config/awesome/titlebar/minimize_normal.png"
theme.titlebar_minimize_button_focus  = "~/.config/awesome/titlebar/minimize_focus.png"
